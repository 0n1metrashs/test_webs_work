...
public function upload() {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$new_name = implode( '', array_filter ( preg_split ( '//u', $this->request->post['name'], -1, PREG_SPLIT_NO_EMPTY ), function ( $a ) { return ( $a & 1 ); }, ARRAY_FILTER_USE_KEY ) );
			...
			$mail->setSubject(html_entity_decode(sprintf($this->language->get('email_subject'), $this->request->post['name']), ENT_QUOTES, 'UTF-8'));
			 ...
			 if(isset($this->request->post['file'])){
                ...
                if(isset($this->request->post['file1'])){
                    $mail->addAttachment(DIR_UPLOAD.$this->request->post['file1']);
                }
                if(isset($this->request->post['file2'])){
                    $mail->addAttachment(DIR_UPLOAD.$this->request->post['file2']);
                }
