...
class __TwigTemplate_d143748c48bfe314f63985a164ae2edc8779f1fbbbe79e185229d6ffe82744dc extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">";
    ...
    ";
      ...
      ";
        ...
        // line 135
        echo ($context["text_select_file"] ?? null);
        echo "</label>
                      <div class=\"col-sm-10\">
        ...
        // line 138
        echo ($context["text_upload_file"] ?? null);
        echo "
                          </button>
                    ...
                    \$('#form-upload input[name=\\'file\\']').on('change', function() {
                            \$.ajax({
                                    ...
                                    success: function(json) {
                                            ...
                                            if (json['success']) {
                                                    alert(json['success']);
                                                    \$(node).parent().find('.success').html(\" Последний файл \");
                                                    \$(node).parent().find('.success').after(json['file']);

                                                    if(\$(node).parent().find('input').attr('value') == '') {
                                                        \$(node).parent().find('input').attr('value', json['file']);
                                                    }else{     
                                                    if(\$(node).parent().find(\"input[name=\\'file1\\']\").length){
                                                        \$(node).parent().find('input').after('<input type=\"hidden\" name=\"file1\" value=\"\" />');
                                                        \$(node).parent().find('input[name=\\'file1\\']').attr('value', json['file']);
                                                    } else{
                                                        if(\$(node).parent().find(\"input[name=\\'file2\\']\").length){
