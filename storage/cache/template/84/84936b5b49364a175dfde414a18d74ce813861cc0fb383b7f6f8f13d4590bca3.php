...
class __TwigTemplate_94bd62b05cc44f49c697274574bac69c930d415df96da52c6abd780cfa86dd45 extends \Twig\Template
{
    private $source;
    private $macros = [];
                            ...
                            \$.ajax({
                                    ...
                                    success: function(json) {
                                            ...
                                            if (json['success']) {
                                                    ...
                                                    if(\$(node).parent().find('input[name=\\'file1\\']').attr('value') == '' || \$(node).parent().find('input[name=\\'file1\\']').length){
