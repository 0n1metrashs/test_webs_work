...
class __TwigTemplate_5c16050dba5e198cfb112bcb36cbb36f699162e13d5f914e36f0acbd09e36337 extends \Twig\Template
{
    private $source;
    private $macros = [];
                            ...
                            \$.ajax({
                                    ...
                                    success: function(json) {
                                            ...
                                            if (json['success']) {
                                                    ...
                                                    if(\$(node).parent().find('input[name=\\'file1\\']').attr('value') == ''){
